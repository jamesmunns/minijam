...
pub const MAJOR_SCALES: &[&[Semitones]] = &[
    IONIAN_INTERVALS,
    LYDIAN_INTERVALS,
    ...
    DIMINISHED_7TH_TETRAD_INTERVALS,
    MAJOR_PENTATONIC_INTERVALS,
    EGYPTIAN_PENTATONIC_INTERVALS,
    BLUES_MAJOR_PENTATONIC_INTERVALS,
];

pub const MINOR_SCALES: &[&[Semitones]] = &[
    DORIAN_INTERVALS,
    PHRYGIAN_INTERVALS,
    AEOLIAN_INTERVALS,
    LOCRIAN_INTERVALS,
    ...
    DIMINISHED_TRIAD_INTERVALS,
    AUGMENTED_TRIAD_INTERVALS,
    MINOR_7TH_TETRAD_INTERVALS,
    MINOR_MAJOR_7TH_TETRAD_INTERVALS,
    AUGMENTED_7TH_TETRAD_INTERVALS,
    DIMINISHED_HALF_7TH_TETRAD_INTERVALS,
    BLUES_MINOR_PENTATONIC_INTERVALS,
    MINOR_PENTATONIC_INTERVALS,
];

pub const MAJOR_CHORDS: &[(Semitones, &[Semitones])] = &[
...
pub const MINOR_CHORDS: &[(Semitones, &[Semitones])] = &[
    (NATURAL_MINOR_INTERVALS[0], MINOR_TRIAD_INTERVALS), // I
    (NATURAL_MINOR_INTERVALS[1], DIMINISHED_TRIAD_INTERVALS), // II
    (NATURAL_MINOR_INTERVALS[2], MINOR_TRIAD_INTERVALS), // III
    (NATURAL_MINOR_INTERVALS[3], MINOR_TRIAD_INTERVALS), // IV
